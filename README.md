...
> **Data Analysis Project** â€” Missing value identification, handling, and exploratory analysis on sales datasets.
...
**`selling.csv`** â€” Sales transaction data with columns likely including:
- Product information
- Sales figures
- Date/time stamps
...
**`choose.txt`** â€” Configuration or feature selection notes (inspect for details)
...
```text
APP2026/
â”œâ”€â”€ Identify and Dropping Missing Values.ipynb   # Main analysis notebook
â”œâ”€â”€ selling.csv                                   # Primary dataset
â”œâ”€â”€ choose.txt                                    # Feature selection / config notes
...
*Data cleaning is 80% of data science â€” master it early.* â€” Last updated July 2026